...
it('mirrors the daemon acp failure copy, including prefixed codes',async()=>{
 ...
 expect(executionErrorMessage('acp_attachment_image_unsupported')).toContain('这个版本的 Cursor')
 expect(executionErrorMessage('acp_prompt_too_large')).toContain('4 MB')
 expect(executionErrorMessage('attachment_image_unsupported')).toContain('PNG')
 expect(executionErrorMessage('attachment_data_missing')).toContain('重新添加')
