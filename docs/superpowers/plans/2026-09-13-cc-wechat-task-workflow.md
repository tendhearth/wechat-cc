...
- Modify `src/daemon/bootstrap/wire-workbench.ts`; create `wire-workbench-artifacts.test.ts` — compose the explicit worker and close it with the workbench lifecycle.
