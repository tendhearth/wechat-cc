...
import {isWechatTaskCommand,type WechatMessageIdentity} from '../../core/workbench/wechat-control'

export interface WorkbenchMwDeps {
  handleWechat(chatId:string,text:string,identity?:WechatMessageIdentity):Promise<string|null>
